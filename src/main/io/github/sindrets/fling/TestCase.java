...
import io.github.sindrets.fling.expector.*;
...
public class TestCase implements TestExpector, CompareExpector, ProcedureExpector {
    ...
    public boolean toBe(Object expectation) {
        ...
        boolean isEqual = expectation == null || actual == null ? actual == expectation
                : actual.equals(expectation);
    ...
    public String toString() {
        ...
        switch (this.status) {
            case NOT_STARTED:
                s.append(chalk.bgYellow().black().bold().apply(" NOT STARTED ") + " "
                        + chalk.blackBright().apply(this.description));
                break;

            case FAILED:
                s.append(chalk.red().apply("✗") + " "
                        + chalk.blackBright().apply(this.description));
                if (!omitExplanation) {
